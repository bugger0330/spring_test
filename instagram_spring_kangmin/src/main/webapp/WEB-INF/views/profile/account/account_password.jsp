...
<head>
    ...
    <link rel="stylesheet" href="/kangmin/static/css/account.css">
...
<body>
            ...
            <div id="container">
                <article>
                    <section class="side-bar">
                        <a href="/kangmin/profile/account">
                        	<div class="side-bar-item">
                            	<h3>프로필 편집</h3>
                        	</div>
                        </a>
                        <a href="/kangmin/profile/account/password">
                        ...
                        <form class="profile-box-form1">
                            <div class="box-item-left">
                                <div class="profile-img-round">
                                    <img src="/kangmin/static/images/instagram.jpg">
                                </div>
                            </div>
                            <div class="box-item-right">
                                <h1 class="profile-username username-sizeup">aaa</h1>
                            </div>
                        </form>
                        <form class="profile-box-form2" action="/kangmin/profile/account/password/update" method="put">
                            <div class="box-items">
                                <div class="box-item-left">
    ...
    <script type="text/javascript" src="/kangmin/static/js/principal.js"></script>
    <script type="text/javascript" src="/kangmin/static/js/account-password.js"></script>
</body>

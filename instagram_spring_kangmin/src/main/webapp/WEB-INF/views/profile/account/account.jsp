...
<body>
                    ...
                    <section class="profile-box">
                        <form class="profile-box-form1"  enctype="multipart/form-data">
                            ...
                            <div class="box-item-right">
                                <h1 class="profile-username">aaa</h1>
                            ...
                            <div class="box-items">
                                ...
                                <div class="box-item-right">
                                    <div class="input-items">
                                        <input type="text" id="name" class="text-input" name="name" value="강민">
    ...
    <script type="text/javascript" src="/kangmin/static/js/account.js"></script>
